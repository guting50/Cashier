 ...
 */
public class ShadowDrawableWhiteWrapper extends DrawableWrapper {
    ...
    public ShadowDrawableWhiteWrapper(Context context, Drawable content, float radius,
                                      float shadowSize, float maxShadowSize) {
        super(content);

        mShadowStartColor = ContextCompat.getColor(context, R.color.white);
        mShadowMiddleColor = ContextCompat.getColor(context, R.color.white);
        mShadowEndColor = ContextCompat.getColor(context, R.color.white);
