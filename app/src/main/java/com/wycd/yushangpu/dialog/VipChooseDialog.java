...
public class VipChooseDialog extends Dialog {
    ...
    TextView tvIntegral;
    @Bind(R.id.btn_keyboard_7)
    Button btnKeyboard7;
    @Bind(R.id.btn_keyboard_8)
    Button btnKeyboard8;
    @Bind(R.id.btn_keyboard_9)
    Button btnKeyboard9;
    @Bind(R.id.btn_keyboard_4)
    Button btnKeyboard4;
    @Bind(R.id.btn_keyboard_5)
    Button btnKeyboard5;
    @Bind(R.id.btn_keyboard_6)
    Button btnKeyboard6;
    @Bind(R.id.btn_keyboard_1)
    Button btnKeyboard1;
    @Bind(R.id.btn_keyboard_2)
    Button btnKeyboard2;
    @Bind(R.id.btn_keyboard_3)
    Button btnKeyboard3;
    @Bind(R.id.btn_keyboard_0)
    Button btnKeyboard0;
    @Bind(R.id.btn_keyboard_00)
    Button btnKeyboard00;
    @Bind(R.id.btn_keyboard_delete)
    LinearLayout btnKeyboardDelete;
    @Bind(R.id.btn_keyboard_dian)
    Button btnKeyboardDian;
    @Bind(R.id.btn_keyboard_confirm)
    TextView btnKeyboardConfirm;
    @Bind(R.id.ll_keyboard_confirm)
    LinearLayout llKeyboardConfirm;
    @Bind(R.id.ll_fast_consume_keyboard)
