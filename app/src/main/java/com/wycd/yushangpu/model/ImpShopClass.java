...
public class ImpShopClass {
    public void shopclass(final Activity ac,
...
//                    ToastUtils.showToast(ac, "获取商品分类数据失败");
//                    com.blankj.utilcode.util.ToastUtils.showShort("获取商品分类数据失败");
                    back.onErrorResponse("");
                }
            }
