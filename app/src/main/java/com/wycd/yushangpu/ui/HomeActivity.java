...
public class HomeActivity extends BaseActivity implements ShowMemberPopWindow.OnItemClickListener, ShowStorePopWindow.OnItemStoreClickListener {
    ...
    TextView tvShoukuan;
    @Bind(R.id.li_shoukuan)
    RelativeLayout liShoukuan;
    @Bind(R.id.btt_price_exchange)
    Button bttPriceExchange;
    @Bind(R.id.btt_dicount_exchange)
    Button bttDicountExchange;
    @Bind(R.id.btt_money_exchange)
    Button bttMoneyExchange;
    @Bind(R.id.btt_num_exchange)
    Button bttNumExchange;
    @Bind(R.id.btt_delte)
    Button bttDelte;
    @Bind(R.id.btt_give)
    Button bttGive;
    @Bind(R.id.btt_royalty)
    Button bttRoyalty;
    @Bind(R.id.btt_get_order)
    Button bttGetOrder;
    @Bind(R.id.btt_hung_order)
    Button bttHungOrder;
    @Bind(R.id.btt_hung_money)
    Button bttHungMoney;
    @Bind(R.id.btt_reture_goods)
    Button bttRetureGoods;
    @Bind(R.id.btt_recharge)
    Button bttRecharge;
    @Bind(R.id.btt_vip_member)
    Button bttVipMember;
    @Bind(R.id.btt_business)
    Button bttBusiness;
    @Bind(R.id.iv_top_left)
    ImageView ivTopLeft;
    @Bind(R.id.iv_top_right)
    ImageView ivTopRight;
    @Bind(R.id.recyclerview_firstclass)
    RecyclerView mRecyclerviewFirstclass;
    @Bind(R.id.gridview)
    GridView mGridview;
    @Bind(R.id.tv_front_page)
    TextView tvFrontPage;
    @Bind(R.id.tv_page)
    TextView tvPage;
    @Bind(R.id.tv_total_page)
    TextView tvTotalPage;
    @Bind(R.id.im_next_page)
    TextView imNextPage;
    @Bind(R.id.sp_goods_order_num)
    Spinner spGoodsOrderNum;
    @Bind(R.id.tv_tatol_num)
    TextView tvTatolNum;
    ...
    CheckBox cbMessage;
    @Bind(R.id.refresh_goods_consume)
    WaveSwipeRefreshLayout mRefreshLayout;//刷新布局
    @Bind(R.id.btn_home_print_set)
    Button btnHomePrint;
    @Bind(R.id.btn_home_label)
    Button btnHomeLabel;
